...
## 2026-07-24 - Button Layout Shift
**Learning:** Adding loading spinners or changing text during loading states causes layout shift on buttons without fixed widths.
**Action:** Use minimum width utility classes (e.g., `min-w-[130px]`) along with flexbox centering when implementing loading states on buttons to prevent layout shift.
