...
## 2026-08-27 - Add focus rings to interactive grid buttons
**Learning:** Interactive items within a CSS grid often rely solely on hover states for visual feedback, completely neglecting keyboard users who rely on focus-visible styles to know where they are navigating.
**Action:** Always ensure interactive elements like buttons and links explicitly define focus-visible classes (`focus:outline-none focus-visible:ring-2 focus-visible:ring-[color] focus-visible:ring-offset-2`) alongside hover states.
