...
**Learning:** Statically assigning `aria-controls` to an element that is conditionally rendered leads to referencing a non-existent ID when the condition is false.
