...
## 2026-07-18 - Empty State Actionability
**Learning:** Empty states without actionable links leave users stranded, forcing them to manually navigate the app to resolve the blocker.
**Action:** Always include a direct, actionable link (with proper focus states) to the resolution area (e.g., Settings) within empty state messages.
