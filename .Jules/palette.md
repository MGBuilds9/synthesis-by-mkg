...
## 2026-07-29 - Add focus visible styles for keyboard navigation
**Learning:** Interactive elements like the integration buttons in settings lack focus indicators, making keyboard navigation inaccessible.
**Action:** Ensure all interactive elements include `focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2` (or equivalent focus styles) so keyboard users can identify the current focus state.
