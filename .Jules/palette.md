...
## 2026-08-31 - Keyboard Focus Visibility
**Learning:** Interactive grid/card connection buttons often lack visible focus states, making keyboard navigation difficult or impossible to track for users relying on keyboard interactions.
**Action:** Always ensure that interactive UI elements, particularly larger card-like buttons, explicitly define `focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500` (or an appropriate ring color) to provide clear keyboard focus indicators.
