...
## 2026-03-09 - Actionable Empty States
**Learning:** Empty states displaying "No data" (like "No emails yet" or "No files yet") without inline actions create friction and require users to hunt for the setup page.
**Action:** Always include an actionable `<Link>` in empty states pointing directly to the relevant settings or connection page so the user can easily resolve the empty state.
