...
## 2026-07-28 - Storage Page Async Action Feedback
**Learning:** The "Search" button on the Storage page lacked visual feedback (spinner) during async operations, leading to potential user uncertainty.
**Action:** Implemented a standard "Loading" state pattern with the `Loader2` icon and disabled state for the Search button to improve interaction feedback.
