...
## 2026-08-09 - Cache LLM Provider Instances
**Learning:** Instantiating external SDK clients (like OpenAI, Anthropic) per request creates new HTTP keep-alive agents and TLS connections, adding latency (TTFB).
**Action:** Cache these provider instances at the module level to reuse connections across requests.
