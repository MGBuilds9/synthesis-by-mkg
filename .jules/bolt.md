...
## 2026-08-09 - Cache SDK instances at module level
**Learning:** Instantiating external SDK clients per-request causes overhead by not reusing underlying HTTP keep-alive agents, increasing TTFB.
**Action:** Cache SDK client instances at the module level in Node.js/serverless environments.
