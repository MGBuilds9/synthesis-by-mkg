...
## 2026-09-24 - Extract Static Data from Render Loop
...
**Action:** Extract static data into constants outside the component definition to ensure a single instance is shared and avoid unnecessary re-allocation.
