...
## 2026-08-11 - Static Array Allocation in React
**Learning:** Initializing static arrays inside a component body (e.g. via `useState`) allocates new memory and triggers unnecessary work during component mounting or re-renders.
**Action:** Move static data arrays and constants outside the component definition to ensure a single instance is shared across renders.
