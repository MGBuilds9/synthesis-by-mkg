...
## 2026-08-03 - Cache SDK Client Instances
**Learning:** Instantiating external SDK client instances (e.g., OpenAI, Anthropic) on every request in serverless/Node.js environments prevents the reuse of underlying HTTP keep-alive agents, increasing TLS handshake latency.
**Action:** Cache these provider instances at the module level to significantly reduce TTFB.
