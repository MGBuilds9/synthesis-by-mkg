...
## 2024-11-20 - Extract static object and array literals from component useState

**Learning:** Initializing static object or array literals directly within `useState` inside the component body re-evaluates and re-allocates the memory on every render.
**Action:** Extract static data into constants outside the component definition to ensure a single instance is shared and avoid unnecessary reallocation overhead.
