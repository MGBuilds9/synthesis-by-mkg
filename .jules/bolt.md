...
## 2026-08-06 - Cache LLM Provider Instances
**Learning:** Re-instantiating external SDK clients (like OpenAI or Anthropic) on every API request increases TLS handshake latency (TTFB) due to the lack of underlying HTTP keep-alive agent reuse.
**Action:** Always cache external SDK client instances at the module level in serverless/Node.js environments to reuse connections and reduce latency.
