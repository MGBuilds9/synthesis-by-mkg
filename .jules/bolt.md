...
## 2026-08-05 - Cache LLMProvider instances

**Learning:** Recreating SDK client instances per request adds significant overhead due to TLS handshakes.
**Action:** Cache these instances to reuse HTTP keep-alive agents and reduce TTFB on subsequent calls.
