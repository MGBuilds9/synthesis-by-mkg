...
## 2026-08-10 - LLM Provider Caching
**Learning:** Instantiating external SDK clients per-request introduces unnecessary TLS handshake latency (TTFB).
**Action:** Cache external SDK client instances at the module level to reuse underlying HTTP keep-alive agents and significantly reduce TLS handshake latency.
