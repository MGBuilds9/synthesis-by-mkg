...
## 2026-08-26 - Cache LLM Provider Instances
**Learning:** Instantiating external SDK clients per-request in serverless/Node.js environments is inefficient. Caching them at the module level allows reuse of HTTP keep-alive agents and significantly reduces TLS handshake latency.
**Action:** Always cache SDK clients at the module level and expose a reset function for testing to prevent state leakage.
