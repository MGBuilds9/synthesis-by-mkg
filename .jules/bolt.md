...
## 2026-08-04 - Module-Level LLM Client Caching
**Learning:** Instantiating external SDK clients (like OpenAI or Anthropic) on every request causes significant TLS handshake latency and TTFB overhead, as underlying HTTP keep-alive agents cannot be reused.
**Action:** Cache external SDK client instances at the module level in serverless/Node.js environments to reuse HTTP keep-alive agents and reduce TTFB.
