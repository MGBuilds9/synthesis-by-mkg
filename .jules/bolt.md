...
## 2026-09-01 - Cache LLM Provider Instances
**Learning:** Instantiating external SDK clients per-request introduces unnecessary TLS handshake latency. Caching them at the module level allows reuse of underlying HTTP keep-alive connections, significantly reducing TTFB.
**Action:** Implement module-level caching using a Map for provider instances, and expose a reset function for testing.
