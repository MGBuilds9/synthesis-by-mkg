...
## 2026-06-24 - Conditional aria-controls Attributes
**Learning:** Using a static `aria-controls` ID string pointing to a conditionally rendered DOM element fails IDREF validation when the element is hidden.
