...
## 2026-04-14 - Search Consistency
**Learning:** The Notion page search lacked standard keyboard shortcuts and clear buttons, breaking the unified UX experience and making it harder for users with keyboards to navigate.
**Action:** Ensure all dashboard search inputs consistently use `shortcutSymbol` pattern, clear buttons, and accessible aria-labels.
