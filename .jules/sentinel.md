...
## 2024-03-10 - Missing Rate Limiting on /api/messages/list
**Vulnerability:** The /api/messages/list endpoint is missing rate limiting.
...
**Prevention:** Consistently apply rate limiting to all list/fetch endpoints.
