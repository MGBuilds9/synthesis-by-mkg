...
## 2026-08-08 - Insecure Logging of Credentials
**Vulnerability:** The sign-in page logged the user's email and plaintext password to the console during the sign-in process.
**Learning:** Never log sensitive user credentials (passwords, tokens, API keys) in plaintext. This exposes them to anyone with access to the console or log aggregation systems.
**Prevention:** Always remove debug logging before pushing code, especially in authentication flows.
