...
## 2026-05-29 - Plaintext Password Logging
**Vulnerability:** The sign-in form logged the plaintext password to the console when submitted (`console.log('Sign in with:', { email, password })`).
**Learning:** Client-side logging of sensitive credentials like passwords can expose them to unauthorized parties via browser developer tools or log aggregation services.
**Prevention:** Never log sensitive credentials like passwords, tokens, or API keys to the console or any logs.
