...
## 2026-09-26 - Prevent Plaintext Password Logs
**Vulnerability:** Plaintext user passwords were being exposed to the browser console during the sign-in process via `console.log`.
**Learning:** Client-side logs are accessible to browser extensions, malicious scripts, and potentially sent to error tracking tools, making credentials vulnerable to theft.
**Prevention:** Never log raw user credentials to the console or any error monitoring system, even temporarily during development.
