...
export default function AIChatPage() {
  ...
  // ⚡ Bolt: Implemented latest-ref pattern for sendMessage to prevent MessageList re-renders
  // Impact: Prevents O(n) rendering cost of entire message history on every keystroke
