...
export default function AIChatPage() {
  ...
  // Bolt: Use latest-ref pattern for sendMessage to prevent MessageList re-renders
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      {/* Messages */}
      {/* Bolt: Optimized with memoized component and stable callback to prevent re-renders on input changes */}
      <MessageList
        messages={messages}
        loading={loading}
