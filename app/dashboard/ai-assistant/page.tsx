...
export default function AIChatPage() {
  ...
  // We explicitly depend on input, but since onSuggestionClick overrides input,
  // wait... if we depend on input, it still breaks memoization on keystrokes.
  // Instead, we use a ref for the latest input.
