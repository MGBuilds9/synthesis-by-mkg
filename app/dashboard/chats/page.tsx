      ...
      <div className="mb-6 space-y-3 sm:space-y-4">
        <div className="flex gap-3 sm:gap-4 flex-wrap items-center">
          ...
          <button 
            ...
            aria-controls={showFilters && (showWorkspaceSelector || showChannelSelector || selectedPlatform === 'telegram') ? "chat-filter-panel" : undefined}
        ...
        {showFilters && (showWorkspaceSelector || showChannelSelector || selectedPlatform === 'telegram') && (
          <div id="chat-filter-panel" className="flex gap-3 sm:gap-4 flex-wrap items-center bg-gray-50 p-3 sm:p-4 rounded-lg">
