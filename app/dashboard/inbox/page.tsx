          ...
          <div className="flex-1 min-w-full sm:min-w-[300px] sm:max-w-md relative">
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 p-1 rounded-full hover:bg-gray-100 transition-colors touch-manipulation"
