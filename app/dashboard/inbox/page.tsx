        ...
        {showFilters && (
          <div id="filter-panel" className="flex gap-3 sm:gap-4 flex-wrap items-center bg-gray-50 p-3 sm:p-4 rounded-lg">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-1 sm:gap-2 w-full sm:w-auto">
              <label htmlFor="email-account" className="text-sm font-medium text-gray-700 whitespace-nowrap">Email Account:</label>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-1 sm:gap-2 w-full sm:w-auto">
              <label htmlFor="date-range" className="text-sm font-medium text-gray-700 whitespace-nowrap">Date Range:</label>
              <div className="relative w-full sm:w-auto">
                <select
                  id="date-range"
