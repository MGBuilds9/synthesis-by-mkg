...
// Bolt: Extract static data outside component to prevent memory re-allocation on re-renders
const INITIAL_STATS = {
  newEmails: 5,
  newChats: 12,
  recentFiles: 8,
...
export default function DashboardPage() {
  // Bolt: Initialize state directly instead of using useEffect to prevent double-render on mount
  const [todayStats, setTodayStats] = useState(INITIAL_STATS)
  const [connectedAccounts, _setConnectedAccounts] = useState(CONNECTED_ACCOUNTS)
