...
export default function DashboardPage() {
  // Bolt: Initialized mock state directly to prevent an unnecessary second render cycle and improve TTI
  ...
  // Bolt: Extracted static array to constant outside component to prevent re-allocation on every render
