              ...
              <div className="space-y-3 mb-4">
                {accounts.map((account: any) => (
                  <div key={account.id} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                    ...
                    <button aria-label={`Disconnect ${account.provider} account`} className="text-red-600 hover:text-red-700 text-sm rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-1">
                      Disconnect
                    </button>
                  </div>
                ))}
