      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <button
            ...
            className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 min-w-[140px] flex justify-center items-center gap-2"
            disabled={loading}
            aria-busy={loading}
          >
            {loading ? (
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        {loading ? (
          <div className="p-8 flex flex-col items-center justify-center text-gray-500" role="status">
            <Loader2 className="w-8 h-8 animate-spin mb-4 text-blue-500" aria-hidden="true" />
