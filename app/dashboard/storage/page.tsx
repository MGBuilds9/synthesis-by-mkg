...
// Bolt: Memoized table component to prevent re-rendering the entire file list on every search keystroke
const FileTable = memo(function FileTable({ files }: { files: any[] }) {
  return (
