...
// Bolt: Caching LLM provider instances at the module level to reuse underlying HTTP
// keep-alive agents. This significantly reduces TLS handshake latency (TTFB) on subsequent requests.
