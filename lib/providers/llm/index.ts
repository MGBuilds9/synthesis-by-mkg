...
export function getLLMProvider(provider: AiProvider): LLMProvider {
  ...
  // Caching LLM provider instances at the module level prevents reinstantiating SDK clients per request,
  // reusing underlying HTTP keep-alive agents and reducing TLS handshake latency.
