...
describe('InboxPage', () => {
  ...
  it('renders search input', () => {
    ...
    // The placeholder dynamically includes the keyboard shortcut, e.g., 'Search emails... (Ctrl+K)'
    expect(searchInput.getAttribute('placeholder')).toMatch(/Search emails\.\.\. \((Ctrl|Cmd)\+K\)/)
  })
