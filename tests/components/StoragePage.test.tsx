...
describe('StoragePage', () => {
  ...
  it('renders search input and button', async () => {
    ...
    // "Searching..." appears in both button and file list area (one is sr-only, one is aria-hidden)
  ...
  it('shows loading state when searching', async () => {
    ...
    // Should show loading state - appears in button and file list area (one is sr-only, one is aria-hidden)
    expect(screen.getAllByText('Searching...')).toHaveLength(3)
