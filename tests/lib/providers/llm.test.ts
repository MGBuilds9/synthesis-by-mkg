...
import { getLLMProvider, resetProviderCache, OpenAIProvider, ClaudeProvider, GeminiProvider } from '@/lib/providers/llm'
...
describe('LLM Provider Factory', () => {
  ...
  describe('getLLMProvider', () => {
    ...
    it('should return the same instance for consecutive calls', () => {
      const provider1 = getLLMProvider('OPENAI' as any)
      const provider2 = getLLMProvider('OPENAI' as any)
      expect(provider1).toBe(provider2)
    })

    it('should return a new instance after cache reset', () => {
      const provider1 = getLLMProvider('OPENAI' as any)
      resetProviderCache()
      const provider2 = getLLMProvider('OPENAI' as any)
